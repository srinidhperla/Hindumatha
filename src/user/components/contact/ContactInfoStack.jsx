  ...
  return (
    <div className="contact-info-stack">
      <a href={phoneHref} className="contact-info-card block group">
        ...
        <h3 className="mb-1 sm:mb-2 text-base sm:text-lg font-bold text-primary-800">
          Phone
        </h3>
      ...
      <a href={emailHref} className="contact-info-card block group">
        ...
        <span className="font-medium text-caramel-600">
          {businessInfo.email}
        </span>
        <p className="mt-1 text-xs sm:text-sm text-primary-500">
      ...
      <div className="contact-info-card">
        ...
        <p className="whitespace-pre-line text-sm sm:text-base text-primary-600">
      ...
      <a
        ...
        className="flex items-center justify-center space-x-3 rounded-2xl bg-sage-500 p-5 sm:p-6 text-white shadow-lg transition-all hover:bg-sage-600 active:scale-[0.97]"
      >
