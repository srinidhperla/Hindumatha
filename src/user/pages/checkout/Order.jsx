      ...
      <div className="cart-shell">
        <header className="checkout-head">
          <div className="min-w-0">
            <h1 className="cart-head-title">Delivery Details</h1>
            <p className="cart-head-sub">
              Address and delivery slot. Bill review is on the next step.
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="cart-main">
            {/* One divided list: Deliver to → When → Payment → Note. */}
            <div className="checkout-flat">
              <OrderAddressStep
                savedAddresses={addressState.savedAddresses}
                ...
                isAddressServiceable={derived.isAddressServiceable}
                maxDeliveryRadiusKm={derived.maxDeliveryRadiusKm}
                storeLocation={derived.normalizedDeliverySettings.storeLocation}
              ...
              <OrderDeliveryStep
                formData={formData}
                normalizedDeliverySettings={derived.normalizedDeliverySettings}
