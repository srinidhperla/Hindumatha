...
import ContactInfoStack from "@/user/components/contact/ContactInfoStack";
import ContactFormCard from "@/user/components/contact/ContactFormCard";
import ContactMapSection from "@/user/components/contact/ContactMapSection";
...
const Contact = () => {
  ...
  return (
    <div className="contact-page">
      <SeoMeta
        title="Contact Us | Hindumatha's Cake World"
        description="Get in touch for custom cake orders, delivery support, and celebration planning with Hindumatha's Cake World, Vizianagaram."
        path="/contact"
      />
